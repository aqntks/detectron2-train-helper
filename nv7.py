...
register_coco_instances(Data_Resister_training,{}, 'coco_cell_train_fold5.json', dataDir)
register_coco_instances(Data_Resister_valid,{},'coco_cell_valid_fold5.json', dataDir)
...
def custom_mapper(dataset_dict):
    ...
    transform_list = [
            ...
            T.ResizeShortestEdge(short_edge_length=(480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864, 896, 928, 960), max_size=2400, sample_style='choice'),
...
# ## Evaluator ######################################
evaluator = COCOEvaluator(Data_Resister_valid, cfg, False, output_dir="./nv/nv7/")
cfg.MODEL.WEIGHTS= "nv/nv7/model_final.pth"
