...
def setup():
    ...
    register_coco_instances('sartorius_train', {}, 'live_test_train.json', dataDir)
    register_coco_instances('sartorius_val', {}, 'live_test_val.json', dataDir)
