# transfer/tl2/model_0134847  /  fold3
...
def setup():
    ...
    register_coco_instances('sartorius_train', {}, 'coco_cell_train_fold3.json', dataDir)
    register_coco_instances('sartorius_val', {}, 'coco_cell_valid_fold3.json', dataDir)
