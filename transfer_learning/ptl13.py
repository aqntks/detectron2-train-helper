# transfer/tl2/model_0134847  /  fold4
...
def setup():
    ...
    register_coco_instances('sartorius_train', {}, 'coco_cell_train_fold4.json', dataDir)
    register_coco_instances('sartorius_val', {}, 'coco_cell_valid_fold4.json', dataDir)
