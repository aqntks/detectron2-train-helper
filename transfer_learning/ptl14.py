# transfer/tl2/model_0134847  /  fold5
...
def setup():
    ...
    register_coco_instances('sartorius_train', {}, 'coco_cell_train_fold5.json', dataDir)
    register_coco_instances('sartorius_val', {}, 'coco_cell_valid_fold5.json', dataDir)
