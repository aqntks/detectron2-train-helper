# transfer/tl2/model_0134847  / new fold5
...
def setup():
    ...
    register_coco_instances('sartorius_train', {}, 'fold_temp/coco_cell_train_fold5.json', dataDir)
    register_coco_instances('sartorius_val', {}, 'fold_temp/coco_cell_valid_fold5.json', dataDir)
